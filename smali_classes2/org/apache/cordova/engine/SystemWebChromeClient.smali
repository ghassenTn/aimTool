...
.method public onShowFileChooser(Landroid/webkit/WebView;Landroid/webkit/ValueCallback;Landroid/webkit/WebChromeClient$FileChooserParams;)Z
    ...
    .local v5, "selectMultiple":Ljava/lang/Boolean;
    :goto_0
    ...
    .line 234
    .local v7, "acceptTypes":[Ljava/lang/String;
    array-length v0, v7
    ...
    const-string v10, "SystemWebChromeClient"
    ...
    .local v9, "captureIntent":Landroid/content/Intent;
    iget-object v0, v1, Lorg/apache/cordova/engine/SystemWebChromeClient;->parentEngine:Lorg/apache/cordova/engine/SystemWebViewEngine;
    ...
    const-string v12, "android.hardware.camera.any"
    ...
    .line 248
    :try_start_0
    invoke-direct {p0, v11}, Lorg/apache/cordova/engine/SystemWebChromeClient;->createTempFile(Landroid/content/Context;)Ljava/io/File;
    ...
    const-string v13, "Temporary photo capture file: "
    ...
    invoke-static {v10, v12}, Lorg/apache/cordova/LOG;->d(Ljava/lang/String;Ljava/lang/String;)V

    .line 250
    invoke-direct {p0, v11, v0}, Lorg/apache/cordova/engine/SystemWebChromeClient;->createUriForFile(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    ...
    const-string v13, "Temporary photo capture URI: "
    ...
    invoke-virtual {v9, v12, v8}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Landroid/os/Parcelable;)Landroid/content/Intent;
    :try_end_0
    ...
    const-string v12, "Unable to create temporary file for photo capture"

    invoke-static {v10, v12, v0}, Lorg/apache/cordova/LOG;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    .line 255
    const/4 v0, 0x0

    .line 256
    .end local v9    # "captureIntent":Landroid/content/Intent;
    .local v0, "captureIntent":Landroid/content/Intent;
    move-object v9, v0
    ...
    .line 258
    .end local v0    # "captureIntent":Landroid/content/Intent;
    .restart local v9    # "captureIntent":Landroid/content/Intent;
    :cond_2
    const-string v0, "Device does not support photo capture"

    invoke-static {v10, v0}, Lorg/apache/cordova/LOG;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 265
    .local v11, "captureUri":Landroid/net/Uri;
    const/4 v12, 0x0

    invoke-static {v3, v12}, Landroid/content/Intent;->createChooser(Landroid/content/Intent;Ljava/lang/CharSequence;)Landroid/content/Intent;

    move-result-object v13

    .line 266
    .local v13, "chooserIntent":Landroid/content/Intent;
    if-eqz v9, :cond_4
    ...
    invoke-virtual {v13, v4, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;[Landroid/os/Parcelable;)Landroid/content/Intent;
    ...
    invoke-static {v10, v0}, Lorg/apache/cordova/LOG;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v4, Lorg/apache/cordova/engine/SystemWebChromeClient$4;

    invoke-direct {v4, p0, v11, v2}, Lorg/apache/cordova/engine/SystemWebChromeClient$4;-><init>(Lorg/apache/cordova/engine/SystemWebChromeClient;Landroid/net/Uri;Landroid/webkit/ValueCallback;)V

    const/16 v14, 0x1435

    invoke-interface {v0, v4, v13, v14}, Lorg/apache/cordova/CordovaInterface;->startActivityForResult(Lorg/apache/cordova/CordovaPlugin;Landroid/content/Intent;I)V
    :try_end_1
    ...
    const-string v4, "No activity found to handle file chooser intent."

    invoke-static {v10, v4, v0}, Lorg/apache/cordova/LOG;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    .line 308
    invoke-interface {v2, v12}, Landroid/webkit/ValueCallback;->onReceiveValue(Ljava/lang/Object;)V
